export const projects = [
  {
  ...
  },
   {
    ...
    },
    {
      ...
      subtitle: "Figma",
      description:
        "A group portfolio website in different screen sizes",
      image: "./a.PNG",
  ...
  export const skills = [
   "Figma", "Prototyping", "Human Centered Design", "Miro", "Notion", "Adobe XD", "Google Workspace Tools", "Adobe Photoshop"
    
  ] ;

  export const testimonials = [
    {
      quote: "Working with Adeola was like a breath of fresh air! Having someone visually articulate product requirements and user stories into mockups and prototypes was refreshing. It also helps that she is reliable, accountable, and enthusiastic about learning and researching ways to improve user experiences.",
      name: "Adaobi Nwonye",
      company:
        "Africa Resource Company (ARC)",
      image: "./Adaobi.jpg",
    },
